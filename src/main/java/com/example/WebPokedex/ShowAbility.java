...
@WebServlet(name = "ShowAbility", value = "/ShowAbility")
public class ShowAbility extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(pokemon != null) {
            out.println("The abilities and Evolutions are:");
            out.println("Abilities:");
            for (int i = 0; i < pokemon.getAbilities().size(); i++) {
                out.println("          " + pokemon.getAbilities().get(i));
            }
            out.println("<br><br>");
